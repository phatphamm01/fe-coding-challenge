...
import FormulaPerfectScroll from "./class/FormulaPerfectScroll.class";
import { TUseDraggable } from "./draggable.type";
...
const useDraggable: TUseDraggable = <T extends HTMLElement>(
  ...
  useEffect(() => {
    ...
    if (node) {
      ...
      draggable.current.init(new FormulaPerfectScroll());
    }
